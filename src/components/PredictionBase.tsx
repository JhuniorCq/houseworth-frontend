  ...
  return (
    <section className="w-full min-h-screen bg-earth-light flex justify-center items-center md:px-16 md:py-12 lg:px-28 xl:px-36 2xl:px-44">
      <div className="w-full flex flex-col md:shadow md:rounded-3xl md:overflow-hidden">
        ...
        <div className="bg-ghost-white py-8 flex flex-col gap-6">
          <span className="px-10 text-earth-very-strong font-semibold bg-transparent cursor-pointer self-start flex items-center gap-2">
            <IoIosArrowRoundBack />
            <button className="text-[13px]" onClick={returnToHome}>
              Volver
            </button>
          </span>
