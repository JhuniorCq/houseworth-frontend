          ...
          <div className="flex gap-3">
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <p className="text-gray-500 text-sm">
                Tu archivo Excel debe contener las siguientes columnas con estos
                nombres exactos:
              </p>
              ...
              <div className="mt-5 border border-yellow-200 bg-yellow-100 p-3 rounded-lg shadow self-center flex items-center gap-2">
                <GoAlertFill className="text-yellow-600" />
                <p className="text-sm">
